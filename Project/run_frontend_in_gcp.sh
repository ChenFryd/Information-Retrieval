...
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="peaceful-berm-415418"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="chenfryd" # without the @post.bgu.ac.il or @gmail.com part
...
gcloud config set project peaceful-berm-415418
